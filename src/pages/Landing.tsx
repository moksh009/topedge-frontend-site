  ...
  return (
    <>
      ...
      <section className="relative flex flex-col justify-center bg-white text-gray-900 overflow-visible pt-16 sm:pt-16 pb-24 sm:pb-32 min-h-[100vh] sm:min-h-[50vh] lg:flex lg:items-center">
        ...
        <div className="container mx-auto mt-2 sm:mt-20 px-4 sm:px-6 lg:px-8 relative z-10">
          {/* Trust Badges */}
          <div className="flex flex-wrap gap-1 sm:gap-3 justify-center mb-4 sm:mb-6 mt-2 sm:mt-0">
          ...
          <div className="flex flex-col items-center justify-center text-center max-w-4xl mt-0 mx-auto">
            <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-3 sm:mb-5 text-black">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 text-[2.5rem] sm:text-4xl md:text-5xl lg:text-6xl">Recover up to $10k</span> and Save <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600 text-[2.5rem] sm:text-4xl md:text-5xl lg:text-6xl">40+ Hours Weekly</span> Within 45 Days with AI
            </h1>
            <p className="text-lg sm:text-lg md:text-xl text-gray-800 font-medium max-w-3xl mb-0 px-2">
              Our AI automation platform handles customer inquiries, books appointments, and manages follow-ups 24/7, 
              helping businesses recover lost revenue and free up valuable staff time.
            </p>
          </div>
            ...
            <div className="relative z-30 transform translate-y-8 sm:translate-y-14 mb-0">
              ...
              <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl border-2 border-white/50 bg-gradient-to-br from-gray-900 to-black">
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/L2DP3iTrbsE?si=ly7DcX84zF8IHKT4"
              ...
              <div className="absolute -bottom-16 right-0 -z-10 animate-spin-slow">
                <div className="relative w-32 h-32">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <text className="text-xs">
                      <textPath href="#circlePath" className="text-blue-600 font-medium">
                        TRUSTED BY EXPERTS • PREMIUM SOLUTION •
                      </textPath>
                    </text>
                  </svg>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div 
              ...
              data-url="https://calendly.com/topedge/meeting-on-google-meet"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16 animate-fade-in">
              <span className="text-blue-600 font-semibold text-lg mb-4 block tracking-wide font-heading">TRUSTED BY INDUSTRY LEADERS</span>
              <h2 className="text-4xl lg:text-7xl font-heading font-extrabold text-gray-900 mb-6 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-900 bg-clip-text text-transparent">
                Client Success Stories
              </h2>
              <div className="w-32 h-2 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-6 rounded-full animate-pulse-glow"></div>
            </div>
{/* Testimonials Section */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10 px-4 sm:px-0">
              ...
              <div className="w-full max-w-[450px] mx-auto rounded-2xl overflow-hidden shadow-xl border border-blue-200 hover:shadow-2xl transition-shadow duration-300 group animate-fade-in" style={{animationDelay: '100ms'}}>
                ...
                <div className="relative">
                  ...
                  <video
                    ...
                    style={{ height: '320px', objectFit: 'contain', maxWidth: '100%' }}
                  >
                ...
                <div className="p-6 bg-gradient-to-br from-white to-blue-50/30">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-2">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-xl p-3 text-center border border-green-100 shadow-sm">
                      <p className="text-xs text-gray-600 mb-1 font-medium">Monthly Revenue</p>
  ...
  <div className="flex flex-col items-center gap-0 mt-10 sm:mt-20 mb-8 sm:mb-16 w-full overflow-hidden">
    ...
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 w-full px-4 sm:px-0 my-8 sm:my-20 md:my-24 overflow-hidden">
      {/* Harold */}
      <div className="relative rounded-2xl md:rounded-3xl max-w-md md:max-w-xl w-full overflow-hidden">
        <img
          src="/images/testimonials/harold.jpeg"
          alt="Harold Testimonial"
          className="mx-auto object-contain w-full rounded-6xl shadow-2xl"
          style={{ height: 'auto', maxHeight: '1200px', objectFit: 'contain', maxWidth: '100%' }}
          sizes="(min-width: 1068px) 1000px, 320px"
        />
      </div>
      {/* Jake Miller */}
      <div className="relative rounded-2xl md:rounded-3xl w-full md:ml-20 mt-8 md:mt-40 overflow-hidden">
        <img
          src="/images/testimonials/jake-miller.jpeg"
          alt="Jake Miller Testimonial"
          className="mx-auto object-contain w-full rounded-3xl shadow-xl"
          style={{ height: 'auto', maxHeight: '800px', objectFit: 'contain', maxWidth: '100%' }}
          sizes="(min-width: 768px) 600px, 320px"
        />
      </div>
    </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="p-0">
              ...
              <button 
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-700 to-blue-800 text-white font-medium py-3 px-8 rounded-full shadow-md hover:from-blue-800 hover:to-blue-900 transition-colors duration-300 border border-blue-600/20 mt-8"
              >
...
function RealTimeROICalculator() {
  ...
  useEffect(() => {
    ...
    const totalLeads = missedCalls * 4.3; // weekly to monthly
    ...
    const hoursSaved = Math.round(missedCalls * 1.5); // Example: 1.5 hours saved per missed call
    setResults({
      extraLeads,
      newTotalLeads,
      currentCustomers,
  ...
  }, [missedCalls, appointmentValue, closeRate]);
                ...
                <div className="space-y-6 sm:space-y-8">
                  <div className="bg-white p-3 sm:p-5 rounded-xl shadow-sm border border-gray-100">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2 sm:gap-0">
                      <label className="text-gray-700 font-medium text-sm sm:text-base">Weekly Missed Inquiries</label>
                      <span className="text-base sm:text-lg font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-lg">{missedCalls}</span>
                    </div>
                    <input
                      type="range"
                      min="5"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mt-4 mb-4 sm:mb-6">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/30 rounded-xl p-3 sm:p-4 text-center border border-blue-200 shadow-md">
                    <div className="flex flex-col h-full justify-between">
                      <p className="text-xs sm:text-sm text-gray-600 font-medium">Hours Saved</p>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100/30 rounded-xl p-3 sm:p-4 text-center border border-green-200 shadow-md">
                    <div className="flex flex-col h-full justify-between">
                      <p className="text-xs sm:text-sm text-gray-600 font-medium">Revenue Gain</p>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100/30 rounded-xl p-3 sm:p-4 text-center border border-purple-200 shadow-md col-span-2 sm:col-span-1">
                    <div className="flex flex-col h-full justify-between">
                      <p className="text-xs sm:text-sm text-gray-600 font-medium">Extra Leads</p>
