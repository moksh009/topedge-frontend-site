...
const About: React.FC = () => {
  useEffect(() => {
    // Optimized intersection observer with reduced updates
  ...
  return (
    <main className="bg-black min-h-screen relative">
      ...
      <Suspense fallback={<SectionLoader />}>
        ...
        {/* Mission Section - Adjusted spacing for mobile */}
        <div className="animate-on-scroll slide-from-left sm:py-0 py-0">
          <AboutMission />
        </div>

        {/* Values Section - Adjusted spacing for mobile */}
        <div className="animate-on-scroll rotate-in sm:py-0 py-0 -mt-8 sm:mt-0">
          <AboutValues />
        </div>

        {/* Stats Section - Adjusted spacing for mobile */}
        <div className="animate-on-scroll bounce-in sm:py-0 py-0 -mt-8 sm:mt-0">
          <AboutStats />
        </div>
        
        {/* Timeline Section - Adjusted spacing for mobile */}
        <div className="animate-on-scroll clip-path-in sm:py-0 py-0 -mt-8 sm:mt-0">
          <AboutTimeline />
        </div>
