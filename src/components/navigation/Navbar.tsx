...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/testimonials', label: 'Reviews', icon: Star, desc: 'Trust' },
  ...
  const liquidGlass = cn(
    "backdrop-blur-[50px] backdrop-saturate-[180%] bg-white/60 dark:bg-black/40", 
    "border border-white/40 dark:border-white/10",
    "shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)]", // Soft, deep shadow
    "ring-1 ring-white/50 ring-inset" // Inner specular highlight (glass edge)
  );
      ...
      <nav className={cn(
        ...
        >
          ...
          <div className={cn(
            ...
            isScrolled && "bg-white/70 dark:bg-black/60 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)]"
          )}>
            ...
            <Link to="/" className="relative flex items-center gap-3 px-4 group z-10">
              ...
              <span className="font-bold text-slate-900 dark:text-white tracking-tight text-lg flex items-center gap-0.5">
            ...
            <div className="flex items-center gap-2 z-10">
              ...
              <div className="hidden md:flex items-center gap-1 mr-2">
                 <Link 
                   to="/community/home" 
                   className="px-5 py-2 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-black dark:hover:text-white transition-all rounded-full hover:bg-black/5 dark:hover:bg-white/10"
                 >
                   Community
                 </Link>
                 <Link 
                   to="/booking" 
                   className="group relative overflow-hidden px-5 py-2.5 rounded-full text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-all hover:scale-105 active:scale-95 bg-slate-900 dark:bg-white dark:text-black"
                 >
              ...
              >
                ...
                <div className={cn(
                    ...
                    isOpen ? "bg-white/20 rotate-90 text-white" : "bg-white text-slate-900"
                )}>
          ...
          <>
            ...
            <motion.div
              ...
              className={cn(
                ...
                liquidGlass,
                "bg-white/80 dark:bg-[#1a1a1a]/80" // Slightly more opaque for the menu to ensure text legibility
              )}
            >
              <div className="p-3">
