        ...
        {submitStatus === 'success' ? (
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-purple-400 to-pink-500 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x">
                  Get in Touch
                </h1>
              ...
              <motion.form
                ...
                className="space-y-6 backdrop-blur-xl bg-white/5 p-8 rounded-2xl border-2 border-blue-400/60 shadow-lg"
              >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="user_name"
                        required
                        className="w-full bg-white rounded-lg border-2 border-blue-300 px-4 py-3 pl-10 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    name="subject"
                    required
                    className="w-full bg-white rounded-lg border-2 border-blue-300 px-4 py-3 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full bg-white rounded-lg border-2 border-blue-300 px-4 py-3 pl-10 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[120px] resize-none"
                ...
                <button
                  ...
                  className="w-full py-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold shadow-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                  style={{ position: 'relative', overflow: 'hidden' }}
                >
                  {isSubmitting ? (
                    <Loader2 className="animate-spin w-6 h-6" />
                  ) : (
                    <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-x flex items-center gap-2">
