      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-500 max-w-3xl mx-auto leading-relaxed">
            1000’s companies with same service we provide <br />
            Our Differentiating factor is Our Ai System is highly Sales-Trained not just talking bot <br />
            Try our Basic-Demo here.
          </p>
        </div>
                        ...
                        {transcript.length === 0 && !currentLine ? (
                          ...
                          <>
                            ...
                            {transcript.map((msg, i) => (
                              ...
                              >
                                <div className={`max-w-[85%] px-4 py-3 rounded-2xl text-[13px] leading-relaxed shadow-sm ${msg.role === 'assistant'
                            ...
                            {currentLine && (
                              <div className={`flex ${currentLine.role === 'assistant' ? 'justify-start' : 'justify-end'}`}>
                                <div className={`max-w-[85%] px-4 py-3 rounded-2xl text-[13px] leading-relaxed opacity-70 ${currentLine.role === 'assistant'
                                  ? 'bg-[#1C1C1E] text-slate-200 rounded-tl-sm'
                                  : 'bg-[#0A84FF] text-white rounded-tr-sm'
                                  }`}>
                                  {currentLine.text}
              ...
              <div className="relative z-30 w-full px-12 pb-12 pt-6 bg-black">
                <div className="flex items-center justify-between w-full max-w-[280px] mx-auto">
                  ...
                  <button
                    ...
                    className={`w-16 h-16 rounded-full flex items-center justify-center text-white shadow-2xl transition-all transform hover:scale-105 active:scale-95 ${isCallActive
                  ...
                  <button
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors active:scale-95 ${isMuted ? 'bg-white text-black' : 'bg-[#1C1C1E] text-slate-400 hover:bg-[#2C2C2E]'
                      }`}
                  >
