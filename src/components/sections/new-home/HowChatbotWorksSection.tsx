...
const CaptureVisual = () => (
  <div className="flex flex-col h-full justify-end pb-4 px-4 space-y-4">
     ...
     <motion.div 
        ...
        className="self-start bg-white border border-slate-100 p-4 rounded-2xl rounded-tl-sm shadow-xl max-w-[90%]"
     >
...
const ScheduleVisual = () => (
  <div className="flex flex-col h-full justify-center space-y-4 px-4">
     <motion.div 
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        className="bg-white border border-slate-100 p-4 rounded-2xl shadow-xl"
     >
        <div className="flex items-center gap-2 mb-4 border-b border-slate-50 pb-3">
           <div className="p-1.5 bg-emerald-100 rounded-md">
              <Calendar size={12} className="text-emerald-600" />
           </div>
           <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Live Availability</span>
        </div>
        ...
        <div className="space-y-2">
           {['10:00 AM', '02:00 PM', '04:30 PM'].map((time, i) => (
              <motion.div 
                 ...
                 className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 border border-slate-100 hover:border-emerald-500/50 hover:bg-emerald-50/50 cursor-pointer transition-all group"
              >
                 <span className="text-sm font-bold text-slate-600 group-hover:text-emerald-700">{time}</span>
     ...
     <motion.div 
        ...
        className="mx-auto bg-emerald-500 text-white px-5 py-2.5 rounded-full text-xs font-bold shadow-lg shadow-emerald-500/30 flex items-center gap-2"
     >
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center order-1 lg:order-2">
             <div className="relative w-full max-w-[360px] aspect-[9/18]">
                ...
                <div className="absolute inset-0 bg-white rounded-[3rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] border-[8px] border-white ring-1 ring-slate-900/5 overflow-hidden z-10">
                   ...
                   {/* Phone Header */}
                   <div className="h-20 bg-white/90 backdrop-blur-md border-b border-slate-50 flex items-end px-6 pb-3 z-20 relative">
                      <div className="flex items-center gap-3 w-full">
                         ...
                         <div className="flex-1">
                            <div className="text-sm font-bold text-slate-900 leading-none mb-1">TopEdge Assistant</div>
                   ...
                   {/* Phone Content Area */}
                   <div className="absolute inset-0 pt-20 pb-20 bg-slate-50/50">
                   ...
                   {/* Phone Footer Input */}
                   <div className="absolute bottom-0 left-0 right-0 h-20 bg-white border-t border-slate-50 px-6 flex items-center">
                      <div className="flex-1 h-10 bg-slate-50 rounded-full flex items-center px-4 justify-between border border-slate-100">
                         <span className="text-slate-400 text-sm">Type a message...</span>
                         <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-md shadow-blue-600/20">
                            <ArrowRight size={16} />
                         </div>
                      </div>
                   </div>
