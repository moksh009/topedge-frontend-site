  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        {/* Bento Grid - 12 Column System for Asymmetric Widths */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          
          {/* Card 1: Cost Saving (Wider - 7 Cols) */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            whileHover={{ y: -5 }}
            className="lg:col-span-8 bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-10 shadow-sm hover:shadow-xl hover:shadow-indigo-900/5 transition-all duration-500 relative overflow-hidden flex flex-col justify-between"
          >
            <div className="mb-8 relative z-10">
              ...
              <div className="space-y-3 text-slate-600 text-base leading-relaxed max-w-lg">
          ...
          {/* Card 2: Enterprise Grade (Narrower - 5 Cols) */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            whileHover={{ y: -5 }}
            className="lg:col-span-4 bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-10 shadow-sm hover:shadow-xl hover:shadow-emerald-900/5 transition-all duration-500 flex flex-col relative overflow-hidden"
          >
             {/* Background Decoration */}
             <div className="absolute -right-10 -top-10 w-64 h-64 bg-emerald-50 rounded-full blur-3xl opacity-50 pointer-events-none" />
             ...
             <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">Enterprise Grade</h3>
                ...
                <div className="space-y-4 mt-auto">
                   {['Private Cloud Deployment', 'End-to-End Encryption', 'Custom Retention Policy'].map((item, i) => (
                      <div key={i} className="flex items-center gap-4 bg-slate-50 p-3 rounded-xl border border-slate-100/50">
