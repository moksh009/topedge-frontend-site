...
const AboutHero: React.FC = () => {
  ...
  // Memoized transform values with proper dependencies
  const scale = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [1, 1, 0.95, 0.9]);
  const opacity = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [1, 1, 1, 0]);
  const y = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [0, 0, 30, 60]);
  const rotate = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [0, 0, -2, -5]);
  ...
  const blurProgress = useSpring(
    useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [0, 0, 2, 4]),
    { 
      stiffness: 200,
      damping: 25,
      restSpeed: 0.1
  ...
  const [particleCount] = useState(() => window.innerWidth < 768 ? 10 : 20);
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black via-black/95 to-[#0A84FF]/20 backdrop-blur-[2px]" />
        </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-32">
        ...
        >
          ...
          >
            <motion.h1 
              variants={textReveal}
              className="flex justify-center items-center text-[2.75rem] sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tight"
            >
              <motion.span 
          ...
          >
            <motion.p 
              className="text-2xl sm:text-2xl md:text-3xl font-light leading-relaxed px-4 sm:px-0"
              style={{
        ...
        <motion.div
          ...
          className="absolute bottom-0 sm:bottom-10 left-1/2 transform -translate-x-1/2 z-100"
        >
          <motion.div
            animate={{
              y: [0, 10, 0],
        ...
        <motion.div
          className="absolute left-4 sm:left-10 top-[35%] sm:top-1/4 text-yellow-500/20"
          animate={{
            y: [-20, 20, -20],
            rotate: [0, 360],
          }}
        ...
        <motion.div 
          className="absolute middle-10 top-[20%] sm:top-1/2 text-cyan-500/20"
          animate={{
            y: [-20, 20, -20],
            rotate: [0, 360],
          }}
        ...
        <motion.div
          className="absolute right-10 top-[45%] sm:top-1/3 text-fuchsia-500/20"
          animate={{
            y: [20, -20, 20],
            rotate: [360, 0],
          }}
        ...
        <motion.div
          className="absolute left-1/4 bottom-[35%] sm:bottom-1/4 text-blue-500/20"
          animate={{
            y: [-30, 30, -30],
            x: [-20, 20, -20],
            rotate: [0, -360],
        ...
        <motion.div
          className="absolute right-1/4 top-[50%] sm:top-1/6 text-green-500/20"
          animate={{
            y: [20, -20, 20],
            x: [20, -20, 20],
            rotate: [360, 0],
