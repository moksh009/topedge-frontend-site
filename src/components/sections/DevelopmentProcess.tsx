...
const DevelopmentProcess = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen py-16 sm:py-24 overflow-hidden sf-pro-display bg-black"
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-16 sm:mb-24">
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-950/40 border border-indigo-500/30 mb-4 sm:mb-6"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
          >
            <Bot className="w-4 sm:w-5 h-4 sm:h-5 text-indigo-400" />
            <span className="text-xs sm:text-sm font-medium text-indigo-300">AI Development Process</span>
          </motion.div>
          ...
          <motion.h2
            ...
            className="text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-indigo-400 via-blue-500 to-indigo-400 text-transparent bg-clip-text text-center px-4"
          >
          ...
          <motion.p 
            ...
            className="mt-4 text-base sm:text-xl text-gray-400 max-w-3xl mx-auto px-4 text-center"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Content */}
                <motion.div 
                  className="relative z-10 p-6 sm:p-8 rounded-2xl bg-gray-900/50 backdrop-blur-xl border border-gray-800 group text-center"
                  whileHover={{ 
                    scale: 1.02,
                ...
                >
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-semibold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                      {step.title}
                    </h3>
                  </div>
                  
                  <p className="text-gray-400/90 mb-6 text-sm sm:text-base">
                    {step.description}
                  </p>
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {step.features.map((feature, i) => (
                      <motion.li
                        ...
                        className="flex items-center justify-center gap-2 text-gray-400/80 text-sm sm:text-base"
                      >
