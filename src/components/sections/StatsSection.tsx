      ...
      >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-900/20 to-black border border-purple-500/20 p-4 sm:p-6 lg:p-8 backdrop-blur-xl transition-all duration-300 hover:border-purple-500/40 text-center h-full">
                {/* Hover Effect */}
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full">
                  <motion.div
                    className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent mb-2 sm:mb-4"
                    initial={{ opacity: 0, y: 20 }}
                    animate={inView ? { opacity: 1, y: 0 } : {}}
                  ...
                  <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-white mb-1 sm:mb-2">{stat.label}</h3>
                  <p className="text-xs sm:text-sm lg:text-base text-gray-400">{stat.description}</p>
                </div>
