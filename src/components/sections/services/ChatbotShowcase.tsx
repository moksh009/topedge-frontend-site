    ...
    <div className="relative mt-32 mb-20 bg-black">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="relative w-full sm:max-w-[420px] md:max-w-[420px] mx-auto px-4">
            <motion.div
            ...
            >
              ...
              <motion.div
                ...
                className="absolute right-[-180px] bottom-[50px] flex items-center z-50"
              >
              ...
              {/* iPhone Frame */}
              <div className="relative w-full h-[800px] sm:h-[860px] bg-[#0A0A0A] rounded-[45px] border-[12px] border-[#1A1A1A] shadow-2xl overflow-hidden">
                {/* Phone Notch */}
