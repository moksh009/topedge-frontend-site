            ...
            {steps.map((step, index) => (
              <div key={index} className="relative mt-24 sm:mt-0">
                ...
                <div className="relative z-10 p-8 rounded-2xl bg-gray-900/50 backdrop-blur-xl border border-gray-800">
                  <h3 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent text-center sm:text-left">
                    {step.title}
                  </h3>
                  <p className="text-gray-400/90 text-center sm:text-left">
                    {step.description}
                  </p>
