...
export const PRODUCT_PAGES: Record<ProductPageId, ProductPage> = {
  ...
  campaigns: {
    ...
    bentoSub: 'Segments, Meta-safe sends, and honest cost — built for Indian D2C WhatsApp growth.',
    bentos: [
      {
        titleLead: 'Behavior',
      ...
      },
      {
        titleLead: 'Frequency',
        titleAccent: 'capping',
        body: 'Meta-safe broadcast sending with built-in caps — so one hot segment doesn’t burn your quality rating.',
        image: '/campaignn.png',
        span: 'third',
      },
      {
  ...
  'audience-crm': {
    ...
    showcases: [
      ...
      },
      {
        title: 'Working',
        titleAccent: 'table',
        body: 'Live carts, values, recovery status, and scores — the same table your team works from every day.',
        image: '/2.png?v=1',
        imageLabel: 'Audience CRM table with lead scores',
      },
      {
        title: 'Segment',
        titleAccent: 'builder',
  ...
  'tracking-pixel': {
    ...
    bentos: [
      ...
      {
        titleLead: 'Consent-aware',
        titleAccent: 'by design',
        body: 'Respects Shopify Customer Privacy settings instead of firing blind — so tracking stays aligned with how the store is configured.',
        image: '/campaignn.png',
        span: 'third',
      },
    ],
  ...
  'ai-brain': {
    ...
    eyebrow: 'AI Brain',
    title: 'Your catalog + policies + persona',
    titleAccent: 'on your API key',
    subtitle:
      'Intelligence hub: store knowledge RAG, bot persona, and BYOK Gemini or OpenAI — you control cost and model. Intent Detect routes phrases without burning tokens on every message.',
    seoTitle: 'AI WhatsApp Chatbot for Shopify | BYOK Gemini/OpenAI + Store Knowledge',
    seoDescription:
    ...
    hero: {
      ...
      alt: 'TopEdge AI Brain — knowledge, persona, and BYOK settings',
      glow: 'violet',
    },
    ...
    showcases: [
      ...
      },
      {
        title: 'Intent',
        titleAccent: 'Detect',
        body: 'Match inbound WhatsApp phrases to tasks — train, live toggle, sandbox test. Save AI tokens for hard catalog questions.',
        image: '/marketing/features/intent-detection-flow.png',
        imageLabel: 'Intent Detect — train and sandbox test',
      },
    ],
    ...
    related: [
      { label: 'BYOK deep-dive', href: '/features/byok' },
  ...
  warranty: {
    ...
    subtitle:
      'Claims intake in the WhatsApp thread they already use — batch tracking at volume, and status through resolution without a spreadsheet.',
    ...
    bentoSub: 'WhatsApp claims, batch records, and status badges — wired to Shopify products.',
    bentos: [
      {
        titleLead: 'Claims via',
        titleAccent: 'WhatsApp',
        body: 'Customers file warranty claims in the same thread they already talk to you in — no separate helpdesk hop.',
        image: '/marketing/solutions/sol-electronics-warranty-saas.png',
        span: 'third',
      },
      {
        titleLead: 'Batch /',
        titleAccent: 'record tracking',
        body: 'Link Shopify products, validity windows, and coverage rules — registrations and claims stay auditable at volume.',
        image: '/marketing/features/unified-identity.png',
        span: 'third',
      },
      {
        titleLead: 'Status through',
        titleAccent: 'resolution',
        body: 'Pending → Approved / Shipped or Rejected with reason — WhatsApp updates go out when you act.',
    ...
    showcasesSub: 'Hub list with status badges, portal OTP, and packaging QR.',
    showcases: [
      {
        title: 'Warranty',
        titleAccent: 'hub',
        body: 'List view with status badges — create batches, set support contacts, and share the public claim URL.',
        image: '/marketing/solutions/sol-electronics-warranty-saas.png',
  ...
  'profit-loss': {
    ...
    hero: {
      kind: 'image',
      src: '/marketing/features/orders-ops.png',
