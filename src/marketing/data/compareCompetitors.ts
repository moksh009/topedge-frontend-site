...
export const COMPARE_COMPETITORS: Record<string, CompareCompetitor> = {
  ...
  interakt: {
    ...
    answerFirst:
      'Pick TopEdge AI for a 14-day trial from ~₹1,800, 0% Meta markup, BYOK AI (~₹0.10–₹0.30 / response), visitor identity pixel, unified identity, and unlimited flows. Pick Interakt if you want a WhatsApp-channel plan from ~₹2,799 with AI Agents as a paid add-on (₹0.50 / message after 100 free).',
    whoForTopEdge:
      'You want flat INR from ~₹1,800, Meta billed direct, BYOK AI, one unified customer profile, warranty, and unlimited flow runs on every plan.',
    whoForCompetitor:
      'You want Interakt’s WhatsApp-channel plans from ~₹2,799 and are fine with platform usage above Meta plus AI Agents as a paid add-on.',
    positioning:
      'Both serve Shopify + WhatsApp in India. Interakt is a WhatsApp marketing suite with tier-capped fields/events and AI Agents as a paid add-on. TopEdge emphasizes Meta pass-through, BYOK AI, unified identity, warranty, and unlimited chatflow execution.',
    differentiators: [
      {
        title: 'Lower starting INR platform fee',
        body: 'TopEdge from ~₹1,800 after a 14-day trial. Interakt WhatsApp-channel plans start from ~₹2,799.',
      },
      {
        title: 'BYOK AI vs ₹0.50 / message add-on',
        body: 'TopEdge BYOK + RAG (~₹0.10–₹0.30 / response). Interakt AI Agents is a paid add-on with ₹0.50 / message after 100 free.',
      },
      {
        title: 'Identity that survives every order',
        body: 'One merged profile with auto-dedupe and warranty batches, not isolated phone-number contacts.',
      },
      {
        title: 'Unlimited flows, every plan',
        body: 'Advanced builder unlocked day one. Interakt caps custom fields, events, and tags by pricing tier.',
      },
    ],
    ...
    scorecard: [
      {
        area: 'Starting subscription',
        topedge: '14-day trial · from ~₹1,800',
        competitor: '14-day trial · from ~₹2,799 (WhatsApp channel plan)',
        edge: 'TopEdge',
      },
      {
        area: 'COD → prepaid',
        topedge: 'Shopify-native + GoKwik / Razorpay stacks',
        competitor: 'Native, locked behind Advanced Shopify on higher tiers',
        edge: 'TopEdge',
      },
      {
        area: 'Meta template economics',
        topedge: '0% markup · Meta direct',
        competitor: 'Platform usage on top of Meta rates',
        edge: 'TopEdge',
      },
      {
        area: 'AI agents',
        topedge: 'BYOK + RAG · ~₹0.10–₹0.30 / response',
        competitor: 'Paid add-on · ₹0.50 / message after 100 free',
        edge: 'TopEdge',
      },
      {
        area: 'Flow builder',
        topedge: 'Advanced builder · unlimited runs',
        competitor: 'Basic linear lower tiers · branching on higher plan',
        edge: 'TopEdge',
      },
      {
        area: 'Unified identity',
        topedge: 'Native merge + lead dedupe',
        competitor: 'Isolated phone-number contact records',
        edge: 'TopEdge',
      },
      {
        area: 'Warranty hub',
        topedge: 'Built-in batches on profile',
        competitor: 'External CRM / custom webhooks',
        edge: 'TopEdge',
      },
      {
        area: 'Account caps',
        topedge: 'Unlimited flow execution all plans',
        competitor: 'Custom fields / events / tags capped by tier',
        edge: 'TopEdge',
      },
    ],
    deepDives: [
      {
        title: 'Subscription floor',
        body: 'Both offer a 14-day free trial. TopEdge then starts from ~₹1,800. Interakt WhatsApp-channel plans start from ~₹2,799. Match the surface you will buy before comparing.',
      },
      {
        title: 'COD → prepaid is tier-gated on Interakt',
        body: 'Interakt supports COD → prepaid natively but locks Advanced Shopify integration on higher-tier plans. TopEdge ships Shopify-native checkout with GoKwik / Razorpay-compatible stacks.',
      },
      {
        title: 'AI agents vs BYOK',
        body: 'Interakt WhatsApp AI Agents is a paid add-on with ₹0.50 per message after 100 free. TopEdge keeps AI on BYOK + RAG at roughly ₹0.10–₹0.30 per response depending on model.',
      },
      {
        title: 'Where Interakt still fits',
        body: 'If your priority is Interakt’s WhatsApp-channel suite and sequential campaigns, and deep native identity / warranty / unlimited flows are secondary, Interakt can be enough.',
      },
    ],
    competitorPlans: [
      {
        ...
        price: 'from ~₹2,799/mo',
        note: '14-day free trial · + Meta / platform usage',
        highlights: [
          'WhatsApp channel included',
          'Sequential campaigns',
          'Rule / keyword linear flows',
          'Standard analytics',
        ],
        popular: true,
      },
      {
        name: 'Higher-tier Shopify',
        price: 'Advanced Shopify+',
        note: 'COD → prepaid unlock typically here',
        highlights: [
      ...
      {
        name: 'AI Agents add-on',
        price: '₹0.50 / message',
        note: 'After 100 free AI messages',
        highlights: [
          'WhatsApp AI Agents module',
          'Per-message AI usage',
          'Paid add-on to subscription',
          'Verify live allowance',
        ],
      },
    ],
    topedgePlansNote:
    ...
    pricingCaveat:
      'Interakt (board copy): 14-day free trial, then WhatsApp-channel plans from ~₹2,799; platform usage on top of Meta; AI Agents add-on at ₹0.50 / message after 100 free. Verify live on interakt.shop / Shopify App Store before purchase.',
    faqs: [
      {
        question: 'How do starting subscriptions compare?',
        answer:
          'Both offer a 14-day free trial. TopEdge then starts from ~₹1,800. Interakt WhatsApp-channel plans start from ~₹2,799, plus Meta and any platform usage charges.',
      },
      {
        question: 'Where do Interakt AI agents unlock?',
        answer:
          'As a paid WhatsApp AI Agents add-on. After a small allowance of 100 free messages, usage is ₹0.50 per message. TopEdge AI is BYOK + RAG (~₹0.10–₹0.30 per response depending on model).',
      },
      {
        question: 'Can Interakt convert COD to prepaid?',
        answer:
          'Yes, natively, but the Advanced Shopify integration is locked on higher-tier plans. TopEdge supports Shopify-native checkout with GoKwik / Razorpay-compatible stacks.',
      },
      {
        question: 'Are Interakt chatbot flows unlimited?',
        answer:
          'No. Custom fields, custom events, and tags are capped by pricing tier. TopEdge includes unlimited flow execution on all plans.',
      },
    ],
    related: [
      { label: 'All comparisons', href: '/compare' },
