    ...
    bentos: [
      {
        ...
        image: '/marketing/solutions/sol-fashion-cart.png',
        wide: true,
        accent: 'Identity',
      },
      {
      ...
      },
      {
        ...
        image: '/marketing/solutions/sol-fashion-campaign.png',
        accent: 'Campaigns',
      },
    ],
    helps: [
    ...
    bentos: [
      {
        ...
        image: '/marketing/solutions/sol-beauty-cart.png',
        wide: true,
        accent: 'Recovery',
      },
      {
        ...
        image: '/marketing/solutions/sol-beauty-catalog.png',
        accent: 'Catalog',
      },
      {
        ...
        image: '/marketing/solutions/sol-beauty-optin.png',
        accent: 'Opt-in',
      },
    ],
    helps: [
    ...
    bentos: [
      {
        ...
        image: '/marketing/solutions/sol-cod-confirm.png',
        wide: true,
        accent: 'Confirm',
      },
      {
        ...
        image: '/marketing/solutions/sol-cod-prepaid.png',
        accent: 'Prepaid',
      },
      {
        ...
        image: '/marketing/solutions/sol-cod-rto.png',
        accent: 'RTO',
      },
    ],
    helps: [
