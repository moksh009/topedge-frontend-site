...
import PriceRoll from '../pricing/PriceRoll';

const LAUNCH_PRICE = 1999;

function formatInrRaw(n: number) {
...
export default function HomeRoiPayoff({ embedded = false }: { embedded?: boolean }) {
  ...
  const multiple = recovered / LAUNCH_PRICE;
  ...
  const body = (
    <div className={`home-roi-lab${embedded ? ' is-embedded' : ''}`}>
      <div className="home-roi-lab__glass">
        ...
        <div className="home-roi-lab__layout">
          <div className="home-roi-lab__result">
            ...
            <div className="home-roi-lab__value mkt-kpi">
              <PriceRoll value={formatInrRaw(recovered)} fastUpdates size="lg" />
            </div>
            <p className="home-roi-lab__week">
              About {formatInrRaw(perWeek)} each week if volume stays steady
            </p>
            ...
            <dl className="home-roi-lab__stats">
              <div>
                <dt>Launch plan</dt>
                <dd>{formatInrRaw(LAUNCH_PRICE)}/mo</dd>
              </div>
              <div>
          ...
          <div className="home-roi-lab__controls">
            ...
            <label className="home-roi-lab__field">
              <span className="home-roi-lab__label">
                Average order value
                <strong className="mkt-kpi">{formatInrRaw(aov)}</strong>
              </span>
              <input
                type="range"
                min={500}
