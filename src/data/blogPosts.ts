 ...
 * Images use public OG assets until dedicated blog media is added.
 */
export const blogPosts: BlogPost[] = [
  {
    ...
    imageAlt: 'WhatsApp cart recovery for Shopify',
    keywords: [
...
<p>Automation should pause when an agent takes over. That is how ecommerce brands protect trust on WhatsApp.</p>
<p><a href="/features">Explore WhatsApp automation features</a> · <a href="/integrations">See Shopify + Meta integrations</a></p>
`,
  },
  {
    id: 3,
    ...
    content: `
<p>Cash on delivery wins conversion and loses margin when RTO spikes. <strong>COD confirmation on WhatsApp</strong> is one of the highest-leverage ecommerce automations for Indian Shopify brands.</p>
<h2>Confirm before you ship</h2>
...
`,
  },
  {
    ...
    content: `
<p>Email is still useful for long-form and international buyers. For Indian D2C, <strong>WhatsApp ecommerce automation</strong> usually wins speed-to-reply, cart recovery, and COD conversations.</p>
<h2>Use WhatsApp when</h2>
<ul>
<li>Carts abandon within the hour</li>
<li>Buyers expect COD clarification</li>
<li>Support needs order context in-thread</li>
</ul>
<h2>Keep email when</h2>
<ul>
...
`,
  },
  {
    ...
    content: `
<p>Meta’s WhatsApp Cloud API is the backbone of serious <strong>WhatsApp automation</strong>. Shopify brands that skip template discipline get blocked; brands that treat approvals as product work scale cleanly.</p>
<h2>Know your categories</h2>
<p>Utility, marketing, and service messages have different rates and use cases. Cart reminders and COD confirms often lean utility; drops lean marketing.</p>
<h2>Approve before you automate</h2>
<p>Gate every journey until templates are APPROVED. Pass through Meta rates with no markup so finance can forecast cart recovery volume.</p>
<p><a href="/features/meta-manager">Meta template manager</a> · <a href="/pricing">See Meta rate footnotes</a></p>
`,
  },
  {
    id: 6,
    ...
    content: `
<p>Forwarding WhatsApp Web screenshots is not a support system. A <strong>WhatsApp shared inbox for Shopify</strong> puts order #, COD status, and cart history beside every thread so agents resolve faster.</p>
<h2>Must-haves</h2>
<ul>
<li>Assign and tag conversations</li>
<li>Pause AI on human takeover</li>
<li>WhatsApp + Instagram in one list</li>
</ul>
<p><a href="/features/live-chat">Live Chat feature</a> · <a href="/customers">Customer workflows</a></p>
`,
  },
  {
    id: 7,
    ...
    keywords: [
      'WhatsApp agency',
      'multi-brand WhatsApp automation',
...
`,
  },
  {
    ...
    description:
      'A fast Shopify automation checklist to connect WhatsApp, approve templates, publish cart recovery, and open a shared inbox.',
    ...
    content: `
<p>Use this checklist to stand up <strong>Shopify automation</strong> on WhatsApp without a three-month project.</p>
<ol>
<li>Connect Shopify OAuth</li>
<li>Add WhatsApp Cloud API credentials</li>
<li>Submit cart recovery + COD templates</li>
<li>Publish a 3-step abandoned cart journey (gated on approval)</li>
<li>Invite the team to the shared inbox</li>
